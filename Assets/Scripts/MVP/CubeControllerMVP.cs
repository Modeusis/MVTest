...
namespace Models
{
    public class CubeControllerMVP : BaseController
    {
        private readonly CubeModelMVP _cubeModel;
        
        private Tween _rotatingTween;
        
        public CubeControllerMVP(MvpControllerSetup controllerSetup, Bootstrap bootstrap)
        {
            Bootstrap = bootstrap;
